 ...
 *
 * @author : Isabelle LECOMTE / Hervé SINOQUET
 * Date    : February 2003
 */
...
// Calculated values
	...
	public SafeDailyClimat (SafeInitialParameters settings, 
	...
	*/
	public float infraRedCalculation(SafeInitialParameters settings, float rad, float extraRad,
	...
	*/
	 ...
	 */
	public float getETPPenman (SafeInitialParameters settings, double rg, double visibleSky) {
	...
	*/
	public void calculateSnow (SafeInitialParameters settings, SafeDailyClimat yesterday) {
