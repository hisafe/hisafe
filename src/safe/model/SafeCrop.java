 ...
 public class SafeCrop  implements Serializable {
	...
	private float qNplante;							
 	...
 	/** Crop phenological stage vegetative
		...
		4=ger GERMINATION	
		5=lev LEVEE		
		6=amf acc�l�ration maximale de croissance foliaire		
		7=lax indice foliaire maxi, fin de croissance foliaire nette ou brute selon l�option.		
		8=sen d�but s�nescence nette (option LAInet)		
	...
	*/
	...
	/** Crop Phenological stage reproductive
		1=snu SOL NU
		2=flo Floraison		
		3=drp d�but remplissage des organes r�colt�s		
		4=nou Nouaison (Fin de la nouaison, pour les plantes ind�termin�es)		
		5=des d�but dessication des organes r�colt�s	
		6=mat maturit� physiologique	
		7=rec R�colte
	*/
	...
	*/
	...
	public void processGrowth2 (SafeTestJNA safeJNA, 
		...
		if (this.sticsCrop.nrec > 0) {		//rec
			...
			//rajout� IL 11/06/2025
			//sinon bug sol nu apr�s r�colte 
	...
	*****************************************************/
	...
	//LEV : lev�e ou d�bourrement v�g�tatif
	public int getNlev() {
    ...
    //AMF : acc�l�ration maximale de croissance foliaire, fin de phase juv�nile
	public int getNamf() {
	...
	//SEN : d�but s�nescence nette (option LAInet)
	public int getNsen() {
