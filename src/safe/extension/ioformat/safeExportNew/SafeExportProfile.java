...
public class SafeExportProfile implements  Serializable {
	...
	*/
	...
	public void selectIds(SafeStand s) {
		...
		if ((ids!= null) && (ids.size()>0) ){
			for (Iterator c = ids.iterator(); c.hasNext();) {
				...
				} else if (this.getObject().equals(OBJECT_YIELD)) {
	...
	public String toString(){
		String str = "";
		str = "Objet= "+getObject()+" Subject= "+getSubject()+" FileName="+fileName+" Frequency="+getFrequency();
		return str;
	}
