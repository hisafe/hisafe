...
public class SafeSticsCrop extends Structure implements Serializable {
	...
	public float P_Kmabs1;   // PARAMETER // Constant of nitrogen uptake by roots for the high affinity system // �mole. cm root-1 // PARPLT // 1
	public float P_Kmabs2;   // PARAMETER // Constant of nitrogen uptake by roots for the low affinity system // �mole. cm root-1 // PARPLT // 1
	...
	public float P_Vmax1;   // PARAMETER // Rate of slow nitrogen absorption (high affinity system) // �mole cm-1 h-1 // PARPLT // 1
	public float P_Vmax2;   // PARAMETER // Rate of rapid nitrogen absorption (high affinity system) // �mole cm-1 h-1 // PARPLT // 1
	...
	public float P_stlevdno;   // PARAMETER // phasic duration between emergence and the beginning of nodulation  // degr�s.jours // PARPLT // 1
	public float P_stdnofno;   // PARAMETER // phasic duration between the beginning and the end of nodulation // degree.days // PARPLT // 1
	public float P_stfnofvino;   // PARAMETER // phasic duration between the end of the nodulation and the end of the nodule life   // degr�s.jours // PARPLT // 1
	public float P_vitno;   // PARAMETER // "rate of nodule onset expressed as a proportion of  P_fixmax   per degree day   // nb degr�s.jour-1 // PARPLT // 1
	...
	public float drl[];            // temporel pour s�nescence (racinaire)
	...
	public float upobs[];              // tableau de for�age
	...
	public float tdevelop[];           // temporel pour s�nescence
	...
	public float matuber_rec; // DR 06/04/2012 on garde le matuber � la recolte
	...
	public float RsurRUrac;      // OUTPUT // Fraction of available water reserve (R/RU) over the root profile // 0 � 1
	...
	public float QNexport; // N export�
	...
	public float photnet[];          // OUTPUT // net photosynthesis // t ha-1.j-1  
	  ...
	  public float tetsen[];    // OUTPUT // Teneur en eau en de�a duquel il y a acc�l�ration de s�nescence
	  public float slrac[];    // OUTPUT // contribution racinaire
	  public float cumlr[];    // OUTPUT // pond�ration de cumlracz par la surface de la plante		
	  public float fhumirac[];// OUTPUT // ajout sortie calcul F_humirac		
	  public float deltaimaxi[];// OUTPUT // ajout sortie deltaimaxi
	  public float msfauche; // OUTPUT // matiere seche fauch�e
	...
	*/
	...
	public SafeSticsCrop (SafeSticsCrop origin) {
		...
		this.P_Kmabs1=origin.P_Kmabs1;   // PARAMETER // Constant of nitrogen uptake by roots for the high affinity system // �mole. cm root-1 // PARPLT // 1
		this.P_Kmabs2=origin.P_Kmabs2;   // PARAMETER // Constant of nitrogen uptake by roots for the low affinity system // �mole. cm root-1 // PARPLT // 1
		...
		this.P_Vmax1=origin.P_Vmax1;   // PARAMETER // Rate of slow nitrogen absorption (high affinity system) // �mole cm-1 h-1 // PARPLT // 1
		this.P_Vmax2=origin.P_Vmax2;   // PARAMETER // Rate of rapid nitrogen absorption (high affinity system) // �mole cm-1 h-1 // PARPLT // 1
		...
		this.P_stlevdno=origin.P_stlevdno;   // PARAMETER // phasic duration between emergence and the beginning of nodulation  // degr�s.jours // PARPLT // 1
		...
		this.P_stfnofvino=origin.P_stfnofvino;   // PARAMETER // phasic duration between the end of the nodulation and the end of the nodule life   // degr�s.jours // PARPLT // 1
		this.P_vitno=origin.P_vitno;   // PARAMETER // "rate of nodule onset expressed as a proportion of  P_fixmax   per degree day   // nb degr�s.jour-1 // PARPLT // 1
