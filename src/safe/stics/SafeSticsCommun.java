...
public class SafeSticsCommun extends Structure implements Serializable {
	   ...
	   public int jour;            //  variable pour le stockage du jour courant de la simulation (01 � 31)
	   public int nummois;         //  variable pour le stockage du num�ro de mois courant (01 � 12)
	   ...
	   public float a;  
	   public float effN; // TODO: variable locale. Pas d'inter�t dans la version actuelle de la stocker  
	   public float hi;  
	   public float ha;  
	   public float hpf;  
	   public float rglo;  
	   ...
	   public float dacouche[]; 	// 0 � dacouche sinon pb le jour de la recolte dans densirac (si codeculture = feuille)
	   ...
	   public float FsNH3;       	// OUTPUT // Volatilisation of NH3  // �g.m-2.j-1
	   public float RsurRU;       	// OUTPUT // Fraction of available water reserve (R/RU) over the entire profile // 0 � 1
