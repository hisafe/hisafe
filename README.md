...
You can install the lastest Hi-sAFe release from the Hi-sAFe website. The model runs on PC, Mac, and Linux platforms and requires Java version 1.8 or later.
